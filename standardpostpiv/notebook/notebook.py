...
class PIVReportNotebook:
    ...
    def __init__(self, report, dtime=None):
        ...
        self.sections = {'title': TitleSection(self),
                         'convergence': ConvergenceSection(self),
                         'statistics': StatisticsSection(self),
                         'velocity_plots': VelocityPlots(self),
                         'misc': MiscSection(self), }
